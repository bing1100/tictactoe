...
#include "../TicTacToe/clickablelabel.h"
...
QT_MOC_LITERAL(4, 29, 1), // "h"
QT_MOC_LITERAL(5, 31, 1), // "w"
QT_MOC_LITERAL(6, 33, 6), // "setval"
QT_MOC_LITERAL(7, 40, 2) // "ch"

    },
    "ClickableLabel\0clicked\0\0type\0h\0w\0"
    "setval\0ch"
};
...
static const uint qt_meta_data_ClickableLabel[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Int,    7,    4,    5,
...
void ClickableLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setval((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (ClickableLabel::*_t)(int , int , int );
...
// SIGNAL 0
void ClickableLabel::clicked(int _t1, int _t2, int _t3)
{
